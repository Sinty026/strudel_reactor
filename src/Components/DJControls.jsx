    ...
    return (
        <>
            <div class="input-group mb-3">
                ...
                <input type="text" className="form-control" placeholder="Username" aria-label="cpm" aria-describedby="cpmLabel" id="cmpTextInput" />
            </div>

            <div>
                <label for="volumeRange" className="form-label">Volume</label>
                <input type="range" className="form-range" min="0" max="1" step="0.1" id="volumeRange" />
            </div>
